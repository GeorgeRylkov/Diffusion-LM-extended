#!/bin/bash
#SBATCH --job-name=inference_e2e_bert_rand
#SBATCH --partition=normal
#SBATCH --output=logs/inference_e2e_bert_rand_%j.out
#SBATCH --error=logs/inference_e2e_bert_rand_%j.err
#SBATCH --time=4:00:00
#SBATCH --cpus-per-task=2
#SBATCH --gpus=1

# Inference (batch decode) for E2E-tgt with BERT random 128d embeddings
# HSE Supercomputer

echo "========================================"
echo "Inference: E2E-tgt + BERT random 128d"
...
DIFFUSION_MODEL_DIR=scripts/diffusion_models/diff_e2e-tgt_pad_rand128_transformer_lr0.0001_0.0_2000_sqrt_Lsimple_h128_s2_d0.1_sd101_bert_uncased
