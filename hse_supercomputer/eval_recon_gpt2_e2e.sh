#!/bin/bash
#SBATCH --job-name=eval_recon_gpt2_e2e
#SBATCH --partition=normal
#SBATCH --output=logs/eval_recon_gpt2_e2e_%j.out
#SBATCH --error=logs/eval_recon_gpt2_e2e_%j.err
...
echo "Model: GPT2 e2e 128d — FULL 2000 timesteps"
