#!/bin/bash
#SBATCH --job-name=eval_recon_v2
#SBATCH --partition=normal
#SBATCH --output=logs/eval_recon_frozen_v2_%j.out
#SBATCH --error=logs/eval_recon_frozen_v2_%j.err
...
echo "Model: BERT-tiny frozen 128d v2 — FULL 2000 timesteps"
