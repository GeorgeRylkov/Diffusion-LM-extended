#!/bin/bash
#SBATCH --job-name=inference_roc_fasttext
#SBATCH --partition=normal
#SBATCH --output=logs/inference_roc_fasttext_%j.out
#SBATCH --error=logs/inference_roc_fasttext_%j.err
#SBATCH --time=3:00:00
#SBATCH --cpus-per-task=2
#SBATCH --gpus=1

# Inference (batch decode) for ROCStories with FastText diffusion model
# HSE Supercomputer

echo "========================================"
echo "Inference: ROCStories + FastText"
...
DIFFUSION_MODEL_DIR=scripts/diffusion_models/diff_roc_pad_fasttext128_transformer_lr0.0001_0.0_2000_sqrt_Lsimple_h128_s2_d0.1_sd101
