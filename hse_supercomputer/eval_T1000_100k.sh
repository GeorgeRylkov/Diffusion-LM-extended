#!/bin/bash
#SBATCH --job-name=eval_T1000_100k
#SBATCH --partition=normal
#SBATCH --output=logs/eval_T1000_100k_%j.out
#SBATCH --error=logs/eval_T1000_100k_%j.err
#SBATCH --time=01:00:00
#SBATCH --cpus-per-task=2
#SBATCH --gpus=1

echo "========================================"
echo "Eval T=1000 trained model (100k checkpoint)"
...
CKPT=${MODEL_DIR}/ema_0.9999_100000.pt
...
echo ""
echo "=== Part 2: Multi-noise diagnostic around t=T/2 ==="
