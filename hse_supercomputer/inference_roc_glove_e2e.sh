#!/bin/bash
#SBATCH --job-name=inference_roc_glove_e2e
#SBATCH --partition=normal
#SBATCH --output=logs/inference_roc_glove_e2e_%j.out
#SBATCH --error=logs/inference_roc_glove_e2e_%j.err
#SBATCH --time=4:00:00
#SBATCH --cpus-per-task=2
#SBATCH --gpus=1

# Inference (batch decode) for ROCStories with GloVe embeddings (e2e mode)
# HSE Supercomputer

echo "========================================"
echo "Inference: ROCStories + GloVe e2e"
...
DIFFUSION_MODEL_DIR=scripts/diffusion_models/diff_roc_pad_glo128_transformer_lr0.0001_0.0_2000_sqrt_Lsimple_h128_s2_d0.1_sd101_e2e
