#!/bin/bash
#SBATCH --job-name=diffusion_roc_bert_rand_tan_2
#SBATCH --partition=normal
#SBATCH --output=logs/train_roc_bert_rand_tan_2_%j.out
#SBATCH --error=logs/train_roc_bert_rand_tan_2_%j.err
#SBATCH --time=40:00:00
#SBATCH --cpus-per-task=2
#SBATCH --gpus=1

# Training job for Diffusion-LM on ROCStories with BERT tokenizer + random embeddings
# HSE Supercomputer

echo "========================================"
echo "Diffusion-LM Training: ROCStories + BERT tokenizer (random emb), tan-d noise schedule, d=2"
...
export OPENAI_LOGDIR=diffusion_models/diff_roc_pad_rand768_transformer_lr0.0001_0.0_2000_tan_2_Lsimple_h128_s2_d0.1_sd101_bert

# Change to project directory
cd improved-diffusion/scripts

echo ""
echo "Starting ROCStories + BERT tokenizer training, tan-d noise schedule, d=2..."
python -u train.py \
