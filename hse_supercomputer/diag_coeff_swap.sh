#!/bin/bash
#SBATCH --job-name=diag_coeff_swap
#SBATCH --partition=normal
#SBATCH --output=logs/diag_coeff_swap_%j.out
#SBATCH --error=logs/diag_coeff_swap_%j.err
#SBATCH --time=00:15:00
#SBATCH --cpus-per-task=2
#SBATCH --gpus=1

echo "========================================"
echo "Diagnostic: Coefficient Swap Test"
...
python -u scripts/diag_coeff_swap.py \
