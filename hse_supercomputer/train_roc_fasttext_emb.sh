#!/bin/bash
#SBATCH --job-name=diffusion_roc_fasttext_emb
#SBATCH --partition=normal
#SBATCH --output=logs/train_roc_fasttext_emb_%j.out
#SBATCH --error=logs/train_roc_fasttext_emb_%j.err
#SBATCH --time=40:00:00
#SBATCH --cpus-per-task=2
#SBATCH --gpus=1

# Training job for Diffusion-LM on ROCStories with FastText embeddings (emb mode)
# HSE Supercomputer

echo "========================================"
echo "Diffusion-LM Training: ROCStories + FastText (emb)"
...
export OPENAI_LOGDIR=diffusion_models/diff_roc_pad_fasttext128_transformer_lr0.0001_0.0_2000_sqrt_Lsimple_h128_s2_d0.1_sd101
...
echo ""
echo "Starting ROCStories + FastText training..."
python -u train.py \
