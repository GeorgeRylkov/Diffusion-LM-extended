#!/bin/bash
#SBATCH --job-name=eval_recon_full
#SBATCH --partition=normal
#SBATCH --output=logs/eval_recon_full_%j.out
#SBATCH --error=logs/eval_recon_full_%j.err
...
echo "Model: BERT-tiny frozen 128d — FULL 2000 timesteps"
