#!/bin/bash
#SBATCH --job-name=eval_recon_bert_frozen
#SBATCH --partition=normal
#SBATCH --output=logs/eval_recon_bert_frozen_%j.out
#SBATCH --error=logs/eval_recon_bert_frozen_%j.err
