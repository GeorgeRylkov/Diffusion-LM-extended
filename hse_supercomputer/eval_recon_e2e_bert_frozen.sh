#!/bin/bash
#SBATCH --job-name=eval_recon_e2e_frozen
#SBATCH --partition=normal
#SBATCH --output=logs/eval_recon_e2e_bert_frozen_%j.out
#SBATCH --error=logs/eval_recon_e2e_bert_frozen_%j.err
...
echo "Model: E2E-tgt BERT-tiny frozen 128d — FULL 2000 timesteps"
