#!/bin/bash
#SBATCH --job-name=eval_recon_seed42
#SBATCH --partition=normal
#SBATCH --output=logs/eval_recon_seed_test_%j.out
#SBATCH --error=logs/eval_recon_seed_test_%j.err
#SBATCH --time=00:30:00
#SBATCH --cpus-per-task=2
#SBATCH --gpus=1

echo "========================================"
echo "Seed test: checking if t=1000 spike is a noise artifact"
echo "Model: BERT-tiny frozen 128d (seed=42 vs original seed=101)"
...
echo "Starting per-timestep reconstruction evaluation with seed=42..."
