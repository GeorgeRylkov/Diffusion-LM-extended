#!/bin/bash
#SBATCH --job-name=eval_recon_bert_uncased_s69
#SBATCH --partition=test
#SBATCH --output=logs/eval_recon_bert_uncased_s69_%j.out
#SBATCH --error=logs/eval_recon_bert_uncased_s69_%j.err
...
echo "Model: BERT-uncased random e2e 128d — FULL 2000 timesteps, seed 69"
