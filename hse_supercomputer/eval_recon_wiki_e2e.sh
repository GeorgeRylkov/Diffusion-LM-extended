#!/bin/bash
#SBATCH --job-name=eval_recon_wiki_e2e
#SBATCH --partition=normal
#SBATCH --output=logs/eval_recon_wiki_e2e_%j.out
#SBATCH --error=logs/eval_recon_wiki_e2e_%j.err
#SBATCH --time=02:00:00
#SBATCH --cpus-per-task=2
#SBATCH --gpus=1

echo "========================================"
echo "Per-timestep reconstruction loss — Wiki BERT uncased e2e 128d (FULL 2000 t)"
...
CHECKPOINT=${DIFFUSION_MODEL_DIR}/ema_0.9999_150003.pt

echo ""
echo "Model path: ${CHECKPOINT}"
echo "Wiki corpus + Arrow tokenized dir (paths relative to improved-diffusion/)"
