#!/bin/bash
#SBATCH --job-name=eval_recon_T1000
#SBATCH --partition=normal
#SBATCH --output=logs/eval_recon_T1000_%j.out
#SBATCH --error=logs/eval_recon_T1000_%j.err
...
echo "Model: BERT-tiny frozen 128d (with T=1000 diffusion override)"
...
echo ""
echo "TEST: override diffusion_steps to 1000 (was trained with 2000)"
echo "Max index = 999, so raw index 1000 does NOT exist."
echo "If spike is at T/2, it should appear at t=500."
